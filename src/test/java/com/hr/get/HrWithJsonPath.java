...
public class HrWithJsonPath extends HrTestBase {
    ...
    @Test
    public void test2() {
        //added limit query param to get 107 employees
        ...
        List<String> first_name = jsonPath.getList("items.findAll {it.salary>10000}.first_name");
        System.out.println("first_name = " + first_name);

        //get the max salary first_name
        String maxSalaryName = jsonPath.getString("items.max {it.salary}.first_name");
        //String maxSalaryNameWithPathMethod = response.path("items.max {it.salary}.first_name");
